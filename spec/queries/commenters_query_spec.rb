...
describe TopCommenters::CommentersQuery, type: :query do
  subject { described_class.new(relation, days_amount: days_amount).find_top_commenters(amount: 4) }
  ...
  describe "#find_top_commenters" do
    context "when time limit is set to 7 days" do
      it "finds commenters" do
